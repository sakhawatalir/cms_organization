...
export default function DashboardNav() {
    ...
    // Add menu items
    const addMenuItems = [
        { name: 'Organization', path: '/dashboard/organizations/add', icon: <HiOutlineOfficeBuilding size={16} /> },
        { name: 'Job', path: '/dashboard/jobs/add', icon: <FiBriefcase size={16} /> },
        { name: 'Job Seeker', path: '/dashboard/job-seekers/add', icon: <FiUsers size={16} /> },
        { name: 'Lead', path: '/dashboard/leads/add', icon: <FiTarget size={16} /> },
        { name: 'Hiring Manager', path: '/dashboard/hiring-managers/add', icon: <FiUserCheck size={16} /> },
        { name: 'Task', path: '/dashboard/tasks/add', icon: <FiCheckSquare size={16} /> },
        { name: 'Placement', path: '/dashboard/placements/add', icon: <FiDollarSign size={16} /> },
    ];
    ...
    const navItems = [
        ...
        { name: 'Hiring Managers', path: '/dashboard/hiring-managers', icon: <FiUserCheck size={20} /> },
        { name: 'Planner', path: '/dashboard/planner', icon: <FiCalendar size={20} /> },
        { name: 'Tasks', path: '/dashboard/tasks', icon: <FiCheckSquare size={20} /> },
        { name: 'Goals & Quotas', path: '/dashboard/goals', icon: <FiBarChart2 size={20} /> },
        { name: 'Placements', path: '/dashboard/placements', icon: <FiDollarSign size={20} /> },
        { name: 'Tearsheets', path: '/dashboard/tearsheets', icon: <FiFile size={20} /> },
        { name: 'Admin Center', path: '/dashboard/admin', icon: <FiSettings size={20} /> },
    ...
    return (
        <>
            {/* Top Navigation Bar */}
            <div className="fixed top-0 left-0 right-0 h-12 bg-slate-800 flex items-center z-10 pl-60">
