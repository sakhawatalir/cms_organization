...
export default function AddHiringManager() {
    ...
    const fetchCustomFields = async () => {
        try {
            ...
            if (response.ok) {
                ...
                setCustomFields(customFormFields.sort((a, b) => (a.sortOrder || 0) - (b.sortOrder || 0)));
            }
        } catch (error) {
    ...
    const fetchHiringManager = async (id: string) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.message || 'Failed to fetch hiring manager details');
            }
            ...
            setFormData({
                ...
                title: hm.title || '',
                organizationId: hm.organization_name || hm.organization_id?.toString() || '',
            ...
            if (hm.custom_fields) {
                try {
                    const customFieldValues = typeof hm.custom_fields === 'string'
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log("Sending hiring manager data to API:", JSON.stringify(apiData, null, 2));
            ...
            console.log(`API ${isEditMode ? 'update' : 'create'} response:`, responseText);
            ...
            if (!response.ok) {
                throw new Error(data.message || `Failed to ${isEditMode ? 'update' : 'create'} hiring manager`);
            }
            ...
            console.error(`Error ${isEditMode ? 'updating' : 'creating'} hiring manager:`, err);
    ...
    if (isSubmitting) {
        return <LoadingScreen message={isEditMode ? "Updating hiring manager..." : "Creating hiring manager..."} />;
    }
            ...
            <div className="bg-white rounded-lg shadow p-4 sm:p-6 relative">
                ...
                <div className="flex justify-between items-center border-b pb-4 mb-6">
                    <div className="flex items-center">
                        ...
                        <h1 className="text-xl font-bold">{isEditMode ? 'Edit' : 'Add'} Hiring Manager</h1>
                    </div>
                    <div className="flex items-center space-x-4">
                        <button
                            type="button"
                            onClick={() => router.push('/dashboard/admin/field-mapping?section=hiring-managers')}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="mt-8">
                        <div className="bg-gray-100 p-2 mb-4">
                            <h2 className="font-medium flex items-center">
                                <Image src="/file.svg" alt="Contact" width={16} height={16} className="mr-2" />
                                Contact Information
                            </h2>
                        </div>
                    ...
                    {customFields.length > 0 && (
                        <div className="mt-8">
                            <div className="bg-gray-100 p-2 mb-4">
                                <h2 className="font-medium flex items-center">
                                    <Image src="/file.svg" alt="Custom" width={16} height={16} className="mr-2" />
                                    Custom Fields
                                </h2>
                            </div>
