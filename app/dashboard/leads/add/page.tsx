...
export default function AddLead() {
    ...
    const fetchLead = async (id: string) => {
        ...
        try {
            ...
            setFormData({
                ...
                title: lead.title || '',
                organizationId: lead.organization_name || lead.organization_id?.toString() || '',
            ...
            if (lead.custom_fields) {
                try {
                    const customFieldValues = typeof lead.custom_fields === 'string'
            ...
            setError(err instanceof Error ? err.message : 'An error occurred while fetching lead details');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log("Sending lead data to API:", JSON.stringify(apiData, null, 2));
    ...
    if (isSubmitting) {
        return <LoadingScreen message={isEditMode ? "Updating lead..." : "Creating lead..."} />;
    }
            ...
            <div className="bg-white rounded-lg shadow p-4 sm:p-6 relative">
                ...
                <div className="flex justify-between items-center border-b pb-4 mb-6">
                    <div className="flex items-center">
                        <Image src="/globe.svg" alt="Lead" width={24} height={24} className="mr-2" />
                        <h1 className="text-xl font-bold">{isEditMode ? 'Edit' : 'Add'} Lead</h1>
                    </div>
