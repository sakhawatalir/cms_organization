...
const FieldMapping = () => {
    ...
    const toggleFieldRequired = async (field: CustomField) => {
        try {
            ...
            alert('Failed to update field status: ' + (err instanceof Error ? err.message : 'Unknown error'));
        }
    };
                            ...
                            <tbody>
                                {visibleFields.map((field) => (
                                    <tr key={field.id} className="border-t border-gray-200 hover:bg-gray-50">
                                        ...
                                        <td className="p-3">
                                            <span className="text-sm">{field.sort_order}</span>
                                        </td>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        disabled={!!selectedField} // Don't allow changing field name for existing fields
                                    />
